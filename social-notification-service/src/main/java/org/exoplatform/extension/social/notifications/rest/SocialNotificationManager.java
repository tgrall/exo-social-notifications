 ...
 *
 */
package org.exoplatform.extension.social.notifications.rest;
...
@Path("/extensions/social/notification")
public class SocialNotificationManager implements ResourceContainer {
    
    
    /**
     * Send a message to Space managers with all pending users
